...
@Mod("rpg_mod")
public class RpgModMod {
	public static final Logger LOGGER = LogManager.getLogger(RpgModMod.class);
	public static final String MODID = "rpg_mod";

	public RpgModMod(IEventBus modEventBus) {
